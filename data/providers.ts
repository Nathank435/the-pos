...
export const PROVIDERS: Provider[] = [
  ...
  {
    slug: "toast",
    verdict: "The most complete restaurant platform in the UK - if you'll accept the contract that comes with it.",
    avoidIf: "You run retail, trade mobile, or want no-contract flexibility.",
    metaDescription:
      "Toast POS review (2026): restaurant-first POS with handhelds, KDS and integrated payments. Strong platform, contract commitment. Fees, pros and verdict.",
    name: "Toast",
    logo: "Toast",
    type: "full-pos",
    summary:
    ...
    bestFor: ["Restaurants", "Table service", "Multi-site hospitality"],
    notBestFor: ["Retail shops", "Market stalls", "Sole traders"],
    monthlyFeeFrom: "Quoted (plans by venue)",
    transactionFeeHeadline: "Integrated Toast Payments (quoted rates)",
    cardReaderCostFrom: "Purpose-built hardware (bundled/quoted)",
    contractLength: "Contract terms - check length before signing",
    payoutSpeed: "Typically next business day",
    hasNoMonthlyFee: false,
    hasNoContractOption: false,
    supportsRestaurants: true,
    ...
    hardware: [
      { name: "Toast Flex terminal", priceFrom: "Quoted", note: "Purpose-built countertop touchscreen" },
      { name: "Toast Go 2 handheld", priceFrom: "Quoted", note: "Order + pay at table, kitchen-synced" },
    ],
    affiliateUrl: "https://pos.toasttab.com/uk",
    quoteUrl: "/get-pos-quotes?provider=toast",
    sourceUrls: ["https://pos.toasttab.com/uk"],
    lastChecked: "2026-07-07",
    lastChanged: "2026-07-07",
    changelog: [
      { date: "2026-07-07", note: "Toast added to our comparison (replacing TouchBistro), details verified against Toast's UK site." },
    ],
    editorialRating: {
      overall: 3.9,
      value: 3.5,
